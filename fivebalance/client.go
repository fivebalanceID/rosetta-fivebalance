...
const (
	...
	// genesis block of the fivebalance blockchain for polling
	genesisBlockIndex = 0
...
const (
	// https://fivebalance.org/en/developer-reference#getblock
	requestMethodGetBlock requestMethod = "getblock"

	// https://fivebalance.org/en/developer-reference#getblockhash
	requestMethodGetBlockHash requestMethod = "getblockhash"

	// https://fivebalance.org/en/developer-reference#getblockchaininfo
	requestMethodGetBlockchainInfo requestMethod = "getblockchaininfo"

	// https://developer.fivebalance.org/reference/rpc/getpeerinfo.html
	requestMethodGetPeerInfo requestMethod = "getpeerinfo"

	// https://developer.fivebalance.org/reference/rpc/pruneblockchain.html
	requestMethodPruneBlockchain requestMethod = "pruneblockchain"

	// https://developer.fivebalance.org/reference/rpc/sendrawtransaction.html
	requestMethodSendRawTransaction requestMethod = "sendrawtransaction"

	// https://developer.fivebalance.org/reference/rpc/estimatesmartfee.html
	requestMethodEstimateSmartFee requestMethod = "estimatesmartfee"

	// https://developer.fivebalance.org/reference/rpc/getrawmempool.html
...
const (
	...
	// returned in Fivebalance blocks to be milliseconds.
	timeMultiplier = 1000

	// rpc credentials are fixed in rosetta-fivebalance
	// because we never expose access to the raw fivebalanced
...
// Client is used to fetch blocks from fivebalanced and
// to parse Fivebalance block data into Rosetta types.
//
// We opted not to use existing Fivebalance RPC libraries
...
// NewClient creates a new Fivebalance client.
func NewClient(
	baseURL string,
	genesisBlockIdentifier *types.BlockIdentifier,
	currency *types.Currency,
...
// ParseBlock returns a parsed fivebalance block given a raw fivebalance
...
// https://fivebalancecore.org/en/doc/0.20.0/rpc/blockchain/pruneblockchain
func (b *Client) PruneBlockchain(
	...
	// Parameters:
	//   1. Height
	// https://developer.fivebalance.org/reference/rpc/pruneblockchain.html#argument-1-height
...
// function mirrors the behavior of a similar commit in fivebalance-core.
//
// Source: https://github.com/fivebalance/fivebalance/commit/ab91bf39b7c11e9c86bb2043c24f0f377f1cf514
...
func (b *Client) parseTransactions(
	...
	logger := fivebalanceUtils.ExtractLogger(ctx, "client")
...
func (b *Client) parseTxOperations(
	...
	for networkIndex, input := range tx.Inputs {
		if fivebalanceIsCoinbaseInput(input, txIndex, networkIndex) {
...
// `fivebalanceOutput` transaction output.
func (b *Client) parseOutputTransactionOperation(
	...
	// If we are unable to parse the output account (i.e. fivebalanced
...
func (b *Client) getInputTxHash(
	...
	if fivebalanceIsCoinbaseInput(input, txIndex, inputIndex) {
		return "", -1, false
	}
...
// fivebalanceIsCoinbaseInput returns whether the specified input is
...
func fivebalanceIsCoinbaseInput(input *Input, txIndex int, inputIndex int) bool {
...
// parseOutputAccount parses a fivebalanceScriptPubKey and returns an account
...
// post makes a HTTP request to a Fivebalance node
func (b *Client) post(
	ctx context.Context,
