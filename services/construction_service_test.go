...
func TestConstructionService(t *testing.T) {
	...
	cfg := &configuration.Configuration{
		...
		Params:   fivebalance.TestnetParams,
		Currency: fivebalance.TestnetCurrency,
	}
	...
	metadata := &constructionMetadata{
		ScriptPubKeys: []*fivebalance.ScriptPubKey{
			{
	...
	// Test Submit
	fivebalanceTransaction := "" // nolint
	mockClient.On(
		"SendRawTransaction",
		ctx,
		fivebalanceTransaction,
	).Return(
