	...
	tests := map[string]struct {
		...
		"all set (mainnet)": {
			...
			cfg: &Configuration{
				...
				Params:                 fivebalance.MainnetParams,
				Currency:               fivebalance.MainnetCurrency,
				GenesisBlockIdentifier: fivebalance.MainnetGenesisBlockIdentifier,
				Port:                   1000,
		...
		"all set (testnet)": {
			...
			cfg: &Configuration{
				...
				GenesisBlockIdentifier: fivebalance.TestnetGenesisBlockIdentifier,
				Port:                   1000,
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			...
			if test.err != nil {
				...
				test.cfg.FivebalancedPath = path.Join(newDir, "fivebalanced")
