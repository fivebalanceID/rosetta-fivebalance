...
const (
	// Blockchain is Fivebalance.
	Blockchain string = "Fivebalance"
	...
	// Fivebalance operations because anything
	...
	// of any transaction hash in Fivebalance.
	TransactionHashLength = 64

	// NullData is returned by fivebalanced
...
// Source: https://fivebalanceops.org/en/tools/calc-size/
const (
...
// Fivebalance transaction that satisfies the ScriptPubKey
...
// BlockchainInfo is information about the Fivebalance network.
...
// Block is a raw Fivebalance block (with verbosity == 2).
type Block struct {
...
// Transaction is a raw Fivebalance transaction.
...
// Input is a raw input in a Fivebalance transaction.
type Input struct {
...
// Output is a raw output in a Fivebalance transaction.
type Output struct {
...
// metadata from Fivebalance inputs and outputs.
